...
export default function App() {
  ...
  // State Navigasi Halaman ('custom' atau 'default')
                ...
                <div className="space-y-1">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] font-normal text-gray-500 dark:text-gray-400">Gunakan file PNG milikmu</span>
                    </div>
                  </button>
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] font-normal text-gray-500 dark:text-gray-400">Gunakan bingkai twibbon.png</span>
                    </div>
                  </button>
                </div>
              </div>
      ...
      <main className="max-w-[600px] mx-auto px-4 sm:px-6 py-6 sm:py-8 flex-grow w-full">
        ...
        <header className="text-center mb-6">
          <h1 className="text-2xl sm:text-3xl font-extrabold mb-2 text-gray-900 dark:text-white tracking-tight">
            {activeTab === 'default' ? 'Pasang Twibbon Bawaan' : 'Solusi Pasang Twibbon Instan'}
          </h1>
        ...
        <section className="bg-white dark:bg-slate-800 rounded-2xl shadow-md border border-gray-100 dark:border-slate-700 p-4 sm:p-6 mb-6 w-full">
          ...
          {/* LANGKAH 1: UPLOAD BINGKAI (MODE CUSTOM) */}
          {activeTab === 'custom' && !frameImg && (
          ...
          {/* PREVIEW BINGKAI & LANGKAH UNGGAH FOTO */}
          {frameImg && (
              ...
              <div className="flex items-center gap-4 p-3.5 bg-gray-50 dark:bg-slate-700/40 rounded-xl border border-gray-200 dark:border-slate-700/80 w-full">
                ...
                <div className="flex-1 flex flex-col items-start text-left min-w-0">
                  <p className="text-[11px] font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-tight">
                    {activeTab === 'default' ? 'Bingkai Default:' : 'Dimensi Asli Bingkai:'}
                  </p>
                  <p className="text-sm font-bold text-gray-900 dark:text-white truncate">
                    {activeTab === 'default' ? 'twibbon.png' : `${frameDimensions.width} × ${frameDimensions.height} px`}
                  </p>
